...
(function() {
  ...
  // 12 hero illustrations - randomly picked on each load
  const HERO_ILLUSTRATIONS = [
    // 1. Two faces + hand + plant (original)
    `<svg viewBox="0 0 480 360" xmlns="http://www.w3.org/2000/svg" class="illustration">${roughFilter('h1')}<circle cx="320" cy="130" r="80" fill="${COLORS.clay}" opacity="0.75" filter="url(#h1)"/><circle cx="320" cy="130" r="60" fill="${COLORS.clay}" opacity="0.3" filter="url(#h1)"/><path d="M350 70 C370 68 395 85 398 110 C402 138 388 165 375 180 C360 196 338 205 320 210 C308 213 292 215 285 222 C278 229 276 240 270 248" fill="none" stroke="${COLORS.charcoal}" stroke-width="2.2" stroke-linecap="round" filter="url(#h1)"/><path d="M250 68 C230 66 205 83 202 108 C198 136 212 163 225 178 C240 194 262 203 280 208 C292 211 308 213 315 220 C322 227 324 238 330 246" fill="none" stroke="${COLORS.charcoal}" stroke-width="2.2" stroke-linecap="round" filter="url(#h1)"/><path d="M100 240 C110 235 125 230 140 232 C155 234 168 238 175 245 C182 252 184 265 178 275 C170 288 155 292 140 294 C125 296 108 290 95 282 C80 272 78 257 88 248 Z" fill="none" stroke="${COLORS.charcoal}" stroke-width="2" stroke-linecap="round" filter="url(#h1)"/><path d="M108 242 C104 228 100 215 102 202" fill="none" stroke="${COLORS.charcoal}" stroke-width="1.8" stroke-linecap="round" filter="url(#h1)"/><path d="M124 235 C122 218 120 202 123 188" fill="none" stroke="${COLORS.charcoal}" stroke-width="1.8" stroke-linecap="round" filter="url(#h1)"/><path d="M140 232 C140 214 141 196 144 182" fill="none" stroke="${COLORS.charcoal}" stroke-width="1.8" stroke-linecap="round" filter="url(#h1)"/><path d="M156 235 C158 218 162 200 168 188" fill="none" stroke="${COLORS.charcoal}" stroke-width="1.8" stroke-linecap="round" filter="url(#h1)"/><path d="M168 245 C176 232 185 220 192 210" fill="none" stroke="${COLORS.charcoal}" stroke-width="1.8" stroke-linecap="round" filter="url(#h1)"/><path d="M88 270 C75 282 62 298 55 315" fill="none" stroke="${COLORS.charcoal}" stroke-width="2" stroke-linecap="round" filter="url(#h1)"/><ellipse cx="55" cy="335" rx="20" ry="8" fill="${COLORS.bark}" opacity="0.3" filter="url(#h1)"/><path d="M55 335 L55 290" fill="none" stroke="${COLORS.charcoal}" stroke-width="2" stroke-linecap="round" filter="url(#h1)"/><path d="M55 320 Q40 310 32 300" fill="none" stroke="${COLORS.sage}" stroke-width="2.5" stroke-linecap="round" filter="url(#h1)"/><circle cx="30" cy="295" r="8" fill="${COLORS.clay}" opacity="0.5" filter="url(#h1)"/><path d="M55 308 Q70 298 80 290" fill="none" stroke="${COLORS.sage}" stroke-width="2.5" stroke-linecap="round" filter="url(#h1)"/><circle cx="82" cy="285" r="6" fill="${COLORS.sage}" opacity="0.5" filter="url(#h1)"/><rect x="55" y="80" width="26" height="26" fill="${COLORS.sage}" opacity="0.6" transform="rotate(-15 55 80)" filter="url(#h1)"/><polygon points="390,220 408,255 372,255" fill="none" stroke="${COLORS.stone}" stroke-width="2" filter="url(#h1)"/><circle cx="410" cy="60" r="14" fill="${COLORS.sage}" opacity="0.4" filter="url(#h1)"/><circle cx="440" cy="100" r="8" fill="${COLORS.stone}" opacity="0.4" filter="url(#h1)"/><rect x="430" y="150" width="18" height="18" fill="${COLORS.sage}" opacity="0.3" transform="rotate(25 430 150)" filter="url(#h1)"/><rect x="370" y="260" width="32" height="24" rx="2" fill="none" stroke="${COLORS.charcoal}" stroke-width="1.5" filter="url(#h1)"/><path d="M370 268 L402 268" stroke="${COLORS.stone}" stroke-width="1" filter="url(#h1)"/><rect x="380" y="240" width="28" height="20" rx="2" fill="none" stroke="${COLORS.charcoal}" stroke-width="1.5" filter="url(#h1)"/><path d="M380 248 L408 248" stroke="${COLORS.stone}" stroke-width="1" filter="url(#h1)"/><path d="M20 340 Q100 332 180 338 Q260 344 340 336 Q380 332 420 338 Q450 340 480 336" fill="none" stroke="${COLORS.stone}" stroke-width="1.5" stroke-linecap="round" filter="url(#h1)"/><path d="M20 348 Q80 342 160 346 Q240 350 320 344 Q370 340 420 346 Q450 348 480 344" fill="none" stroke="${COLORS.stone}" stroke-width="1" stroke-linecap="round" opacity="0.5" filter="url(#h1)"/><circle cx="60" cy="120" r="3" fill="${COLORS.clay}" opacity="0.6" filter="url(#h1)"/><circle cx="160" cy="55" r="4" fill="${COLORS.sage}" opacity="0.5" filter="url(#h1)"/><circle cx="220" cy="230" r="3" fill="${COLORS.clay}" opacity="0.4" filter="url(#h1)"/><circle cx="350" cy="280" r="4" fill="${COLORS.stone}" opacity="0.5" filter="url(#h1)"/></svg>`,
    // 2. Mountain landscape
    `<svg viewBox="0 0 480 360" xmlns="http://www.w3.org/2000/svg" class="illustration">${roughFilter('h2')}<circle cx="380" cy="80" r="50" fill="${COLORS.clay}" opacity="0.6" filter="url(#h2)"/><path d="M0 340 L120 120 L200 220 L300 80 L380 160 L480 100 L480 360 Z" fill="${COLORS.sage}" opacity="0.35" filter="url(#h2)"/><path d="M0 360 L80 180 L160 260 L240 120 L320 200 L420 140 L480 180 L480 360 Z" fill="${COLORS.sage}" opacity="0.25" filter="url(#h2)"/><circle cx="300" cy="70" r="10" fill="${COLORS.clay}" opacity="0.5" filter="url(#h2)"/><path d="M20 300 Q120 290 240 296 Q360 302 460 294" fill="none" stroke="${COLORS.stone}" stroke-width="1.5" stroke-linecap="round" filter="url(#h2)"/><path d="M40 340 L80 310 L120 340" fill="none" stroke="${COLORS.charcoal}" stroke-width="1.5" stroke-linecap="round" filter="url(#h2)"/><path d="M120 340 L80 325 L40 340" fill="none" stroke="${COLORS.charcoal}" stroke-width="1.5" stroke-linecap="round" filter="url(#h2)"/><circle cx="80" cy="300" r="4" fill="${COLORS.clay}" opacity="0.5" filter="url(#h2)"/><circle cx="50" cy="50" r="6" fill="${COLORS.stone}" opacity="0.4" filter="url(#h2)"/><circle cx="430" cy="220" r="18" fill="${COLORS.stone}" opacity="0.25" filter="url(#h2)"/></svg>`,
    // 3. Reading/book
    `<svg viewBox="0 0 480 360" xmlns="http://www.w3.org/2000/svg" class="illustration">${roughFilter('h3')}<circle cx="340" cy="120" r="60" fill="${COLORS.clay}" opacity="0.7" filter="url(#h3)"/><path d="M310 70 C330 66 365 80 370 110 C375 140 360 170 345 185 C325 205 298 210 280 210 C262 210 248 205 248 195 C248 185 268 175 280 170 C292 165 310 160 315 150" fill="none" stroke="${COLORS.charcoal}" stroke-width="2" stroke-linecap="round" filter="url(#h3)"/><rect x="80" y="160" width="120" height="90" rx="3" fill="none" stroke="${COLORS.charcoal}" stroke-width="2" filter="url(#h3)"/><rect x="80" y="160" width="120" height="12" fill="${COLORS.clay}" opacity="0.35" filter="url(#h3)"/><path d="M95 190 L180 190" stroke="${COLORS.stone}" stroke-width="1.2" filter="url(#h3)"/><path d="M95 205 L160 205" stroke="${COLORS.stone}" stroke-width="1.2" filter="url(#h3)"/><path d="M95 220 L140 220" stroke="${COLORS.stone}" stroke-width="1.2" filter="url(#h3)"/><circle cx="410" cy="60" r="12" fill="${COLORS.sage}" opacity="0.5" filter="url(#h3)"/><rect x="35" y="80" width="20" height="20" fill="${COLORS.sage}" opacity="0.5" transform="rotate(-10 35 80)" filter="url(#h3)"/><path d="M30 320 Q120 312 240 318 Q360 324 450 316" fill="none" stroke="${COLORS.stone}" stroke-width="1.5" stroke-linecap="round" filter="url(#h3)"/></svg>`,
    // 4. Coffee/pen
    `<svg viewBox="0 0 480 360" xmlns="http://www.w3.org/2000/svg" class="illustration">${roughFilter('h4')}<circle cx="340" cy="90" r="55" fill="${COLORS.clay}" opacity="0.65" filter="url(#h4)"/><path d="M290 62 C310 56 345 68 350 90 C355 115 340 140 325 152 C310 165 285 168 270 166 C255 164 250 155 260 148 C270 141 285 140 290 132" fill="none" stroke="${COLORS.charcoal}" stroke-width="2" stroke-linecap="round" filter="url(#h4)"/><rect x="90" y="140" width="80" height="100" rx="4" fill="none" stroke="${COLORS.charcoal}" stroke-width="2" filter="url(#h4)"/><ellipse cx="130" cy="210" rx="30" ry="10" fill="${COLORS.bark}" opacity="0.3" filter="url(#h4)"/><rect x="170" y="180" width="10" height="65" fill="${COLORS.clay}" opacity="0.5" filter="url(#h4)"/><path d="M220 160 Q280 150 340 158" fill="none" stroke="${COLORS.charcoal}" stroke-width="1.5" stroke-linecap="round" filter="url(#h4)"/><circle cx="70" cy="160" r="12" fill="${COLORS.sage}" opacity="0.5" filter="url(#h4)"/><rect x="380" y="250" width="60" height="6" rx="2" fill="${COLORS.charcoal}" opacity="0.3" filter="url(#h4)"/><path d="M30 320 Q120 308 240 316 Q360 324 450 312" fill="none" stroke="${COLORS.stone}" stroke-width="1.5" stroke-linecap="round" filter="url(#h4)"/><circle cx="50" cy="110" r="5" fill="${COLORS.clay}" opacity="0.5" filter="url(#h4)"/></svg>`,
    // 5. Stars/night
    `<svg viewBox="0 0 480 360" xmlns="http://www.w3.org/2000/svg" class="illustration">${roughFilter('h5')}<circle cx="340" cy="100" r="70" fill="${COLORS.clay}" opacity="0.6" filter="url(#h5)"/><circle cx="340" cy="100" r="50" fill="${COLORS.clay}" opacity="0.2" filter="url(#h5)"/><path d="M310 56 C342 48 378 70 382 100 C386 134 368 168 348 184 C320 205 282 210 256 204 C230 198 228 180 244 168 C260 156 285 150 296 138" fill="none" stroke="${COLORS.charcoal}" stroke-width="2" stroke-linecap="round" filter="url(#h5)"/><circle cx="80" cy="80" r="7" fill="${COLORS.clay}" opacity="0.7" filter="url(#h5)"/><circle cx="130" cy="55" r="5" fill="${COLORS.clay}" opacity="0.5" filter="url(#h5)"/><circle cx="200" cy="70" r="6" fill="${COLORS.clay}" opacity="0.6" filter="url(#h5)"/><circle cx="250" cy="50" r="4" fill="${COLORS.clay}" opacity="0.4" filter="url(#h5)"/><circle cx="160" cy="100" r="3" fill="${COLORS.clay}" opacity="0.5" filter="url(#h5)"/><path d="M80 80 L130 55 L200 70 L250 50" stroke="${COLORS.charcoal}" stroke-width="0.8" stroke-dasharray="3 3" filter="url(#h5)"/><path d="M30 340 Q120 330 240 338 Q360 346 450 336" fill="none" stroke="${COLORS.stone}" stroke-width="1.5" stroke-linecap="round" filter="url(#h5)"/></svg>`,
    // 6. Compass/explore
    `<svg viewBox="0 0 480 360" xmlns="http://www.w3.org/2000/svg" class="illustration">${roughFilter('h6')}<circle cx="340" cy="100" r="65" fill="${COLORS.clay}" opacity="0.7" filter="url(#h6)"/><path d="M310 60 C332 52 368 70 372 100 C376 132 360 162 344 176 C320 196 286 200 264 194 C242 188 240 172 254 162 C268 152 292 148 304 138" fill="none" stroke="${COLORS.charcoal}" stroke-width="2" stroke-linecap="round" filter="url(#h6)"/><circle cx="120" cy="120" r="45" fill="none" stroke="${COLORS.charcoal}" stroke-width="2" filter="url(#h6)"/><circle cx="120" cy="120" r="36" fill="none" stroke="${COLORS.stone}" stroke-width="0.8" stroke-dasharray="4 4" filter="url(#h6)"/><polygon points="120,84 128,114 156,120 128,126 120,156 112,126 84,120 112,114" fill="${COLORS.clay}" opacity="0.6" filter="url(#h6)"/><circle cx="120" cy="120" r="5" fill="${COLORS.charcoal}" filter="url(#h6)"/><path d="M30 300 Q120 290 240 298 Q360 306 450 296" fill="none" stroke="${COLORS.stone}" stroke-width="1.5" stroke-linecap="round" filter="url(#h6)"/></svg>`,
    // 7. Keyboard/code
    `<svg viewBox="0 0 480 360" xmlns="http://www.w3.org/2000/svg" class="illustration">${roughFilter('h7')}<circle cx="350" cy="90" r="70" fill="${COLORS.clay}" opacity="0.65" filter="url(#h7)"/><path d="M320 48 C352 38 388 54 392 88 C396 124 380 158 362 176 C338 198 300 204 274 198 C248 192 244 174 260 160 C276 146 300 140 314 128" fill="none" stroke="${COLORS.charcoal}" stroke-width="2" stroke-linecap="round" filter="url(#h7)"/><rect x="60" y="100" width="160" height="110" rx="3" fill="none" stroke="${COLORS.charcoal}" stroke-width="2" filter="url(#h7)"/><rect x="60" y="100" width="160" height="14" fill="${COLORS.clay}" opacity="0.35" filter="url(#h7)"/><circle cx="70" cy="107" r="3" fill="${COLORS.charcoal}" filter="url(#h7)"/><circle cx="80" cy="107" r="3" fill="${COLORS.charcoal}" filter="url(#h7)"/><circle cx="90" cy="107" r="3" fill="${COLORS.charcoal}" filter="url(#h7)"/><path d="M85 130 L108 148 L85 166" fill="none" stroke="${COLORS.sage}" stroke-width="2" stroke-linecap="round" filter="url(#h7)"/><path d="M195 128 L172 148 L195 168" fill="none" stroke="${COLORS.sage}" stroke-width="2" stroke-linecap="round" filter="url(#h7)"/><line x1="120" y1="148" x2="170" y2="148" stroke="${COLORS.stone}" stroke-width="1.5" filter="url(#h7)"/><path d="M30 320 Q120 310 240 318 Q360 326 450 314" fill="none" stroke="${COLORS.stone}" stroke-width="1.5" stroke-linecap="round" filter="url(#h7)"/></svg>`,
    // 8. Tree/nature
    `<svg viewBox="0 0 480 360" xmlns="http://www.w3.org/2000/svg" class="illustration">${roughFilter('h8')}<circle cx="340" cy="100" r="75" fill="${COLORS.clay}" opacity="0.7" filter="url(#h8)"/><path d="M305 56 C330 48 368 62 374 100 C380 140 362 176 344 194 C320 216 280 220 254 212 C228 204 230 184 248 170 C266 156 290 148 306 134" fill="none" stroke="${COLORS.charcoal}" stroke-width="2" stroke-linecap="round" filter="url(#h8)"/><ellipse cx="120" cy="260" rx="50" ry="15" fill="${COLORS.bark}" opacity="0.35" filter="url(#h8)"/><path d="M120 260 L120 130" fill="none" stroke="${COLORS.charcoal}" stroke-width="2.5" filter="url(#h8)"/><path d="M120 200 Q90 180 76 160" fill="none" stroke="${COLORS.sage}" stroke-width="3.5" stroke-linecap="round" filter="url(#h8)"/><path d="M120 180 Q152 158 170 140" fill="none" stroke="${COLORS.sage}" stroke-width="3.5" stroke-linecap="round" filter="url(#h8)"/><path d="M120 220 Q82 206 60 190" fill="none" stroke="${COLORS.sage}" stroke-width="3" stroke-linecap="round" filter="url(#h8)"/><path d="M120 160 Q158 138 185 120" fill="none" stroke="${COLORS.sage}" stroke-width="3" stroke-linecap="round" filter="url(#h8)"/><circle cx="120" cy="120" r="14" fill="${COLORS.clay}" opacity="0.5" filter="url(#h8)"/><path d="M30 330 Q140 320 240 328 Q360 336 450 324" fill="none" stroke="${COLORS.stone}" stroke-width="1.5" stroke-linecap="round" filter="url(#h8)"/></svg>`,
    // 9. Heart/love
    `<svg viewBox="0 0 480 360" xmlns="http://www.w3.org/2000/svg" class="illustration">${roughFilter('h9')}<circle cx="350" cy="120" r="65" fill="${COLORS.clay}" opacity="0.7" filter="url(#h9)"/><path d="M318 76 C336 66 370 78 376 106 C382 138 364 170 348 186 C328 206 292 210 268 204 C244 198 240 182 256 168 C272 154 296 148 310 136" fill="none" stroke="${COLORS.charcoal}" stroke-width="2" stroke-linecap="round" filter="url(#h9)"/><path d="M200 160 C200 130 160 110 160 140 C160 155 185 180 200 195 C215 180 240 155 240 140 C240 110 200 130 200 160 Z" fill="none" stroke="${COLORS.charcoal}" stroke-width="2" filter="url(#h9)"/><path d="M140 280 Q110 260 100 240" fill="none" stroke="${COLORS.charcoal}" stroke-width="1.5" stroke-linecap="round" filter="url(#h9)"/><circle cx="50" cy="80" r="15" fill="${COLORS.sage}" opacity="0.4" filter="url(#h9)"/><rect x="400" y="200" width="28" height="28" fill="${COLORS.sage}" opacity="0.35" transform="rotate(20 400 200)" filter="url(#h9)"/><path d="M30 320 Q140 308 240 316 Q360 324 450 312" fill="none" stroke="${COLORS.stone}" stroke-width="1.5" stroke-linecap="round" filter="url(#h9)"/></svg>`,
    // 10. Lightbulb/idea
    `<svg viewBox="0 0 480 360" xmlns="http://www.w3.org/2000/svg" class="illustration">${roughFilter('h10')}<circle cx="360" cy="100" r="60" fill="${COLORS.clay}" opacity="0.65" filter="url(#h10)"/><path d="M330 66 C350 56 382 68 386 96 C390 126 376 156 360 172 C340 190 308 195 284 190 C260 185 256 170 270 158 C284 146 308 142 320 130" fill="none" stroke="${COLORS.charcoal}" stroke-width="2" stroke-linecap="round" filter="url(#h10)"/><ellipse cx="130" cy="160" rx="35" ry="42" fill="none" stroke="${COLORS.charcoal}" stroke-width="2" filter="url(#h10)"/><path d="M115 196 L145 196" stroke="${COLORS.charcoal}" stroke-width="2" filter="url(#h10)"/><path d="M120 204 L140 204" stroke="${COLORS.charcoal}" stroke-width="2" filter="url(#h10)"/><path d="M125 212 L135 212" stroke="${COLORS.charcoal}" stroke-width="2" filter="url(#h10)"/><polygon points="126,220 134,220 132,232 128,232" fill="${COLORS.charcoal}" opacity="0.4" filter="url(#h10)"/><circle cx="200" cy="50" r="25" fill="${COLORS.clay}" opacity="0.4" filter="url(#h10)"/><path d="M30 320 Q140 308 240 316 Q360 324 450 312" fill="none" stroke="${COLORS.stone}" stroke-width="1.5" stroke-linecap="round" filter="url(#h10)"/></svg>`,
    // 11. Camera/photo
  ...
  function getRandomHero() {
    var stored = sessionStorage.getItem('hero-illustration-idx');
    var idx;
    if (stored) {
      idx = parseInt(stored, 10);
    } else {
      idx = Math.floor(Math.random() * HERO_ILLUSTRATIONS.length);
      sessionStorage.setItem('hero-illustration-idx', idx);
    }
    return HERO_ILLUSTRATIONS[idx];
  }
  ...
  if (heroEl) heroEl.innerHTML = getRandomHero();
...
>>>>>>> fcafd3c3d56d1f00db72c44397d1c6cbbec47ee2
